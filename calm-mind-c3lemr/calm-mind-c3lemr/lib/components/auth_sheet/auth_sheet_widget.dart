                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            context.goNamedAuth('chatpage', context.mounted);
                          },
                          child: Container(
                            width: double.infinity,
                            height: 60.0,
                      ...
                      Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            GoRouter.of(context).prepareAuthEvent();
                            if (_model.cAPasswordTextFieldTextController.text !=
                                _model.cAConfirmPasswordTextFieldTextController
                                    .text) {
                            ...
                            final user =
                              ...
                              context,
                              _model.cAEmailTextFieldTextController.text,
                              _model.cAPasswordTextFieldTextController.text,
                            );
                            if (user == null) {
                              return;
                            }
