...
class AppStateNotifier extends ChangeNotifier {
  ...
  CalmMindAuthUser? initialUser;
  CalmMindAuthUser? user;
  ...
  void update(CalmMindAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : ChatpageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => CreatePostPageWidget(
                generatedArtResult: params.getParam(
                  'generatedArtResult',
                  ParamType.JSON,
                ),
              ),
