                            ...
                            child: Builder(
                              builder: (context) {
                                ...
                                return ListView.builder(
                                  ...
                                  controller: _model.messagesList,
                                );
                              },
                            ),
                          ),
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            FlutterFlowIconButton(
                              borderRadius: 25.0,
                              buttonSize: 50.0,
                              fillColor: FlutterFlowTheme.of(context).mycolor,
                              icon: Icon(
                                Icons.send_rounded,
                                color: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                              ...
                              onPressed: () async {
                                FFAppState().addToConversation(MessageStruct(
                                ...
                                unawaited(
                                  () async {
                                    await _model.messagesList?.animateTo(
                                      _model.messagesList!.position
                                          .maxScrollExtent,
                                ...
                                if (FFAppState().actioveConversasionId !=
                                  ...
                                  _model.apiResultydt = await ChatCallCall.call(
                                    content: _model.textController1.text,
                                    conversationId:
                                        FFAppState().actioveConversasionId,
                                  );
                                  ...
                                  if ((_model.apiResultydt?.succeeded ??
                                      true)) {
                                    FFAppState()
                                        .addToConversation(MessageStruct(
                                      content: ChatCallCall.response(
                                        (_model.apiResultydt?.jsonBody ?? ''),
                                      ),
                                      role: Role.assistant,
                                    ));
                                    safeSetState(() {});
                                  ...
                                  if ((_model.chatResponse?.succeeded ??
                                    ...
                                    FFAppState()
                                        .addToConversation(MessageStruct(
                                      content: NewChatCallCall.response(
                                        (_model.chatResponse?.jsonBody ?? ''),
                                      ),
                                      role: Role.assistant,
                                    ));
                                ...
                                await _model.messagesList?.animateTo(
                                  _model.messagesList!.position.maxScrollExtent,
                                  duration: Duration(milliseconds: 5000),
                                  curve: Curves.ease,
                                );
